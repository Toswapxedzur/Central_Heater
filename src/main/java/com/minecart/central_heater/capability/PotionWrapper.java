...
public class PotionWrapper implements IFluidHandlerItem {
    ...
    public FluidStack getFluid(){
        if(!container.is(Items.POTION))
            return FluidStack.EMPTY;
        PotionContents potion = container.getOrDefault(DataComponents.POTION_CONTENTS, new PotionContents(Potions.WATER));
    ...
    protected void setFluid(FluidStack stack){
        if(stack.isEmpty()){
            ...
            PotionContents contents = stack.getOrDefault(DataComponents.POTION_CONTENTS, new PotionContents(Potions.WATER));
            this.container = new ItemStack(Items.POTION);
            this.container.set(DataComponents.POTION_CONTENTS, contents);
        }
    }
    ...
    public boolean isFluidValid(int i, FluidStack fluidStack) {
        return fluidStack.isEmpty() || fluidStack.is(Fluids.WATER);
    }
