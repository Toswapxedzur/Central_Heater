...
public class ThrowablePebbleEntity extends ThrowableItemProjectile {
    ...
    private ParticleOptions getParticle() {
        ...
        return (ParticleOptions)(!itemstack.isEmpty() && !itemstack.is(this.getDefaultItem()) ? new ItemParticleOption(ParticleTypes.ITEM, itemstack) : new ItemParticleOption(ParticleTypes.ITEM, AllBlockItem.COBBLE.toStack()));
    }
